...
# mark present(P) in front of their name if recongnized by ID
# mark absent(A) to those who are not marked
# Save the excel sheet
# Display attendace sheet if required 
...
i=2
while(i<row):
    print(str(ws['B'+str(i)].value) + "\t\t\t" + str(ws['C'+str(i)].value))
    i = i+1
